...
from models.modelos import ItemVenta, MovimientoInventario, Producto, Venta
...
class ControladorReportes:
    ...
    def generar_balance_economico(self, fecha_inicio: datetime, fecha_fin: datetime):
        try:
            ...
            margen_utilidad = (
                (utilidad_bruta / total_ventas * 100) if total_ventas > 0 else 0
            )
            ...
            balance = {
                ...
                "resumen_ventas": {
                    ...
                    "ticket_promedio": round(
                        total_ventas / (datos_ventas.cantidad_ventas or 1), 2
                    ),
                },
                "rentabilidad": {
    ...
    def obtener_indicadores_ventas(
        ...
        try:
            ...
            ventas_periodo_actual = (
                self.db.query(func.sum(Venta.total))
                .filter(
                    and_(
                        Venta.fecha_venta >= fecha_inicio,
                        Venta.fecha_venta <= fecha_fin,
            ...
            if ventas_periodo_anterior > 0:
                variacion_ventas = (
                    (ventas_periodo_actual - ventas_periodo_anterior)
                    / ventas_periodo_anterior
                ) * 100
